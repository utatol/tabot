    ...
    switch (type) {
        case 'common':
            switch (jumlah) {
                case '1':
                case 'crate':
                	 let _ir = `${Math.floor(Math.random() * 5)}`.trim()
...
`.trim()
                    if (global.DATABASE._data.users[m.sender].common >= 1) {
                        ...
                        global.DATABASE._data.users[m.sender].iron += ir * 1
                ...
                case '10':
                    ...
                    let _ir2 = `${Math.floor(Math.random() * 15)}`.trim()
...
`.trim()
                    if (global.DATABASE._data.users[m.sender].common >= 10) {
                        ...
                        global.DATABASE._data.users[m.sender].iron += ir2 * 1
                ...
                case '100':
                    ...
                    let _ir3 = `${Math.floor(Math.random() * 50)}`.trim()
...
`.trim()
                ...
                case '1000':
                    ...
                    let _ir4 = `${Math.floor(Math.random() * 100)}`.trim()
...
`.trim()
                    if (global.DATABASE._data.users[m.sender].common >= 1000) {
                        ...
                        global.DATABASE._data.users[m.sender].iron += ir4 * 1
                    ...
                    } else conn.reply(m.chat, 'Common crate anda habis', m)
                    break
                default:
        ...
        case 'uncommon':
            switch (jumlah) {
                ...
                case 'crate':
                    ...
                    let _iro = `${Math.floor(Math.random() * 5)}`.trim()
...
`.trim()
                    if (global.DATABASE._data.users[m.sender].uncommon >= 1) {
                        ...
                        global.DATABASE._data.users[m.sender].iron += iro * 1
                ...
                case '10':
                    ...
                    let _iro1 = `${Math.floor(Math.random() * 15)}`.trim()
...
`.trim()
                    if (global.DATABASE._data.users[m.sender].uncommon >= 10) {
                        ...
                        global.DATABASE._data.users[m.sender].iron += iro1 * 1
                ...
                case '100':
                    ...
                    let _iro2 = `${Math.floor(Math.random() * 50)}`.trim()
...
`.trim()
                    if (global.DATABASE._data.users[m.sender].uncommon >= 100) {
                        ...
                        global.DATABASE._data.users[m.sender].iron += iro2 * 1
                ...
                case '1000':
                    ...
                    let _iro3 = `${Math.floor(Math.random() * 100)}`.trim()
...
`.trim()
                    if (global.DATABASE._data.users[m.sender].uncommon >= 1000) {
                        ...
                        global.DATABASE._data.users[m.sender].iron += iro3 * 1
        ...
        case 'mythic':
            switch (jumlah) {
                ...
                case 'crate':
                    ...
                    let _iron = `${Math.floor(Math.random() * 60)}`.trim()
...
`.trim()
                ...
                case '10':
                    ...
                    let _iron1 = `${Math.floor(Math.random() * 60)}`.trim()
...
`.trim()
                    if (global.DATABASE._data.users[m.sender].mythic >= 10) {
                        ...
                        global.DATABASE._data.users[m.sender].iron += iron1 * 1
                ...
                case '100':
                    ...
                    let _iron2 = `${Math.floor(Math.random() * 100)}`.trim()
...
`.trim()
                    if (global.DATABASE._data.users[m.sender].mythic >= 100) {
                        ...
                        global.DATABASE._data.users[m.sender].iron += iron2 * 1
                ...
                case '1000':
                    ...
                    let _iron3 = `${Math.floor(Math.random() * 200)}`.trim()
...
`.trim()
                    if (global.DATABASE._data.users[m.sender].mythic >= 1000) {
                        ...
                        global.DATABASE._data.users[m.sender].iron += iron3 * 1
        ...
        case 'legendary':
            switch (jumlah) {
                ...
                case 'crate':
                    ...
                    let _kn = `${Math.floor(Math.random() * 300)}`.trim()
...
`.trim()  
                    if (global.DATABASE._data.users[m.sender].legendary >= 1) {
                        ...
                        global.DATABASE._data.users[m.sender].iron += kn * 1
                ...
                case '10':
                    ...
                    let _kn1 = `${Math.floor(Math.random() * 400)}`.trim()
...
`.trim()  
                    if (global.DATABASE._data.users[m.sender].legendary >= 10) {
                        ...
                        global.DATABASE._data.users[m.sender].iron += kn1 * 1
                ...
                case '100':
                    ...
                    let _kn2 = `${Math.floor(Math.random() * 500)}`.trim()
...
`.trim()  
                    if (global.DATABASE._data.users[m.sender].legendary >= 100) {
                        ...
                        global.DATABASE._data.users[m.sender].iron += kn2 * 1
                ...
                case '1000':
                    ...
                    let _kn3 = `${Math.floor(Math.random() * 2000)}`.trim()
...
`.trim()  
                    if (global.DATABASE._data.users[m.sender].legendary >= 1000) {
                        ...
                        global.DATABASE._data.users[m.sender].iron += kn3 * 1
